...
<section class="singlepost">
    <div class="container singlepost__container">
        ...
        <h5>Cybersecurity is the practice of protecting systems, networks, and programs from digital attacks, damage, or unauthorized access.</h5>
        <p>
            Cybersecurity is the practice of protecting systems, networks, and programs from digital attacks1. 
            These cyberattacks are usually aimed at accessing, changing, or destroying sensitive information; 
            extorting money from users via ransomware; or interrupting normal business processes1.
             Cybersecurity refers to any technology, measure or practice for preventing cyberattacks or 
             mitigating their impact2. It aims to protect individuals’ and organizations’ systems, applications, 
             computing devices, sensitive data and financial assets against simple and annoying computer viruses, 
             sophisticated and costly ransomware attacks, and everything in between2. 
             The accelerating volume of data sources, and subsequently data, has made 
             cybersecurity one of the fastest-growing fields across every industry3. 
             As a result, the role of the cybersecurity professional is becoming increasingly important as organizations become more 
             reliant on them to interpret data and provide actionable recommendations to improve business outcomes
        </p>
