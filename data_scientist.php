...
<section class="singlepost">
    <div class="container singlepost__container">
        <h2>Know how to preprocess,analyze and visualize the data </h2>
        ...
        <h5>Data Science is a multidisciplinary field that uses scientific methods, processes, algorithms, and systems to extract knowledge and insights from structured and unstructured data.</h5>
        <p>
            Data Science is an interdisciplinary field that uses scientific methods, 
            processes, algorithms, and systems to extract knowledge and insights 
            
            from structured and unstructured data12. It combines math and statistics, 
            
            specialized programming, advanced analytics, artificial intelligence (AI),
             and machine learning with specific subject matter expertise to uncover 
            actionable insights hidden in an organization’s data1. These insights 
            can be used to guide decision making and strategic planning1.
            
            The accelerating volume of data sources, and subsequently data, 
            has made data science one of the fastest growing fields across every industry1. 
            As a result, the role of the data scientist was dubbed the “sexiest job of the 21st century” 
            by Harvard Business Review1. Organizations are increasingly reliant on them to interpret data and provide actionable recommendations to improve business outcomes
        </p>
